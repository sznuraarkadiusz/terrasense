  <template>
    <div class="bg-gray-100">
      <h1 class="dashboard__title text-center mx-auto">Kalendarz</h1>
      ...
      <div class="flex justify-center flex-wrap items-center pt-6">
        <div class="p-4 bg-white rounded-lg shadow-md w-full max-w-4xl">
          ...
          <div class="grid grid-cols-7 gap-2 bg-gray-100 p-4 rounded-lg shadow-inner">
          ...
          <div v-for="data in filteredSensorData" :key="data.time" class="grid grid-cols-7 gap-2 bg-white p-4 rounded-lg shadow-md mt-2">
